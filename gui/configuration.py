...
UPDATE_INTERVAL = 0.1
AUTOMATIC_START_BROWSER = False #when true opens automatically the browser
DEBUG_MODE = 1 #0 - NO DEBUG  1 - ALERTS AND ERRORS  2 - MESSAGES
